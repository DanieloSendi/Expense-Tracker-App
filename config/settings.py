...
DEBUG = os.getenv("DEBUG", "False") == "True" if not os.getenv("RENDER") else False

ALLOWED_HOSTS = ['https://expense-tracker-vlon.onrender.com', 'localhost', '127.0.0.1']
